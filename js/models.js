...
class StoryList {
   ...
   */
	...
	async removeStory (user, storyId) {
		...
		// filter out the story that we are removing
		this.stories = this.stories.filter((story) => story.storyId !== storyId);

		// do the same for the users list of stories & favorites
		user.ownStories = user.ownStories.filter((s) => s.storyId !== storyId);
		user.favorite = user.favorites.filter((s) => s.storyId !== storyId);
	}
}
...
class User {
   ...
   */
	...
	/** Add story to the list of favorites and update API
	...
	/** Remove a sotry from the favorites and update API
	...
	/** Return true/false if given story is a favorite of the user */
